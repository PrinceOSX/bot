...
class BuddyMessageRequest:
  ...
  def write(self, oprot):
    ...
    if self.contentMetadata is not None:
      ...
      for kiter42,viter43 in list(self.contentMetadata.items()):
...
class BuddyOnAirUrls:
  ...
  def write(self, oprot):
    ...
    if self.hls is not None:
      ...
      for kiter58,viter59 in list(self.hls.items()):
    ...
    if self.smoothStreaming is not None:
      ...
      for kiter60,viter61 in list(self.smoothStreaming.items()):
...
class ChannelException(TException):
  ...
  def write(self, oprot):
    ...
    if self.parameterMap is not None:
      ...
      for kiter76,viter77 in list(self.parameterMap.items()):
...
class Message:
  ...
  def write(self, oprot):
    ...
    if self.contentMetadata is not None:
      ...
      oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.contentMetadata))
      for kiter176,viter177 in list(self.contentMetadata.items()):
...
class MetaProfile:
  ...
  def write(self, oprot):
    ...
    if self.identities is not None:
      ...
      for kiter192,viter193 in list(self.identities.items()):
...
class NotificationItem:
  ...
  def write(self, oprot):
    ...
    if self.content is not None:
      ...
      for kiter201,viter202 in list(self.content.items()):
...
class PaymentReservationResult:
  ...
  def write(self, oprot):
    ...
    if self.extras is not None:
      ...
      for kiter217,viter218 in list(self.extras.items()):
...
class Settings:
  ...
  def write(self, oprot):
    ...
    if self.snsAccounts is not None:
      ...
      for kiter268,viter269 in list(self.snsAccounts.items()):
    ...
    if self.customModes is not None:
      ...
      for kiter270,viter271 in list(self.customModes.items()):
...
class TalkException(TException):
  ...
  def write(self, oprot):
    ...
    if self.parameterMap is not None:
      oprot.writeFieldBegin('parameterMap', TType.MAP, 3)
      oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.parameterMap))
      for kiter286,viter287 in list(self.parameterMap.items()):
...
class UniversalNotificationServiceException(TException):
  ...
  def write(self, oprot):
    ...
    if self.parameterMap is not None:
      oprot.writeFieldBegin('parameterMap', TType.MAP, 3)
      oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.parameterMap))
      for kiter316,viter317 in list(self.parameterMap.items()):
